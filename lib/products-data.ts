...
export const products: Product[] = [
  ...
  // ── P07 NEST CARRY™ ──────────────────────────────────────────────────────
  {
    ...
    benefitsList: [
      ...
      { title: 'Practical liquid management without improvisation', desc: 'The 50 mL and 100 mL collection jars address a real post-surgical need. Two sizes. 100 mL jar has measurement markings.' },
    ...
    careText: [
      'Spot clean the bag with a damp cloth',
      'Wipe jars clean after use',
      'Keep diary dry',
    ],
    careDonts: [
      'Do not submerge bag in water',
      'Do not autoclave jars',
    ],
    whatsIncluded: [
      'Recovery sling bag',
      'Smiley therapy ball',
    ...
    faqs: [
      ...
      { q: 'What are the collection jars for?', a: 'After some breast surgeries, surgical drains are placed to collect fluid during the healing process. The 50 mL and 100 mL jars with measurement markings allow for easy, accurate tracking of drain output as recommended by your healthcare team.' },
  ...
  // ── P10 BROWBLOOM™ ───────────────────────────────────────────────────────
  {
    ...
    materialsText: 'Lightweight, skin-safe construction designed for gentle daily wear and easy removal without harsh adhesives or chemicals.\n\nThe application adhesive is formulated for sensitive skin. Removal is by gentle soaking, not pulling — designed to protect skin that may already be reactive during treatment.',
    careText: [
      'Follow included application guide for positioning',
      'Remove gently after soaking',
      'Store in the included case',
    ],
    careDonts: [
      'Do not apply to irritated skin',
      'Do not use harsh removers',
  ...
  // ── P12 BLOOMCROWN™ ──────────────────────────────────────────────────────
  {
    ...
    careText: [
      ...
      'Store on the included wig stand or in the dust bag',
